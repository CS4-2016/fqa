      ...
      <div class="row">
       ...
       <!--  <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              <a href="#" class="fontColor"><h4>Cloud Storage</h4></a>
              <p><br></p>
            </div>
            <div class="icon">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              <a href="standards.php" class="fontColor"><h4>Manage Standards</h4></a>
              <p><br></p>
            </div>
            <div class="icon">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-blue">
            <div class="inner">
              <a href="download-docs.php" class="fontColor"><h4>Download File</h4></a>
              <p><br></p>
            </div>
            <div class="icon">
